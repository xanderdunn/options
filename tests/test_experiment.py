...
def test_discrete_gridworld_experiment():
    ...
    agent = Agent(RandomPolicy(environment.num_actions), TabularFA(environment.num_states(), environment.num_actions), environment.num_actions,
                  0.1, 0.99, 0.1, 0.1, 0.05, 10, 0, 0)
